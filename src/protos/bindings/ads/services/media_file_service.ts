...
class MutateMediaFilesRequest$Type extends MessageType<MutateMediaFilesRequest> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateMediaFilesRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MediaFileOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
    ...
    create(value?: PartialMessage<MutateMediaFilesRequest>): MutateMediaFilesRequest {
        ...
        if (value !== undefined)
            reflectionMergePartial<MutateMediaFilesRequest>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MediaFileOperation operations */ 2:
                    message.operations.push(MediaFileOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: MutateMediaFilesRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.operations.length; i++)
            MediaFileOperation.internalBinaryWrite(message.operations[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
 ...
 */
export const MutateMediaFilesRequest = new MutateMediaFilesRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MediaFileOperation$Type extends MessageType<MediaFileOperation> {
    constructor() {
        super("google.ads.googleads.v11.services.MediaFileOperation", [
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => MediaFile }
        ]);
    }
    create(value?: PartialMessage<MediaFileOperation>): MediaFileOperation {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<MediaFileOperation>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.ads.googleads.v11.resources.MediaFile create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: MediaFile.internalBinaryRead(reader, reader.uint32(), options, (message.operation as any).create)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: MediaFileOperation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.operation.oneofKind === "create")
            MediaFile.internalBinaryWrite(message.operation.create, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const MediaFileOperation = new MediaFileOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateMediaFilesResponse$Type extends MessageType<MutateMediaFilesResponse> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateMediaFilesResponse", [
            { no: 3, name: "partial_failure_error", kind: "message", T: () => Status },
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MutateMediaFileResult }
        ]);
    }
    create(value?: PartialMessage<MutateMediaFilesResponse>): MutateMediaFilesResponse {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<MutateMediaFilesResponse>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateMediaFileResult results */ 2:
                    message.results.push(MutateMediaFileResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: MutateMediaFilesResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.results.length; i++)
            MutateMediaFileResult.internalBinaryWrite(message.results[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const MutateMediaFilesResponse = new MutateMediaFilesResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateMediaFileResult$Type extends MessageType<MutateMediaFileResult> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateMediaFileResult", [
            ...
            { no: 2, name: "media_file", kind: "message", T: () => MediaFile }
        ]);
    }
    create(value?: PartialMessage<MutateMediaFileResult>): MutateMediaFileResult {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<MutateMediaFileResult>(this, message, value);
        return message;
    }
    ...
    internalBinaryWrite(message: MutateMediaFileResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.mediaFile)
            MediaFile.internalBinaryWrite(message.mediaFile, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const MutateMediaFileResult = new MutateMediaFileResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.MediaFileService
 */
export const MediaFileService = new ServiceType("google.ads.googleads.v11.services.MediaFileService", [
    { name: "MutateMediaFiles", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/mediaFiles:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: MutateMediaFilesRequest, O: MutateMediaFilesResponse }

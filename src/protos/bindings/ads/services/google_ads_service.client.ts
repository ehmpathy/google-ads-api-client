...
import { GoogleAdsService } from "./google_ads_service";
 ...
 * @generated from protobuf service google.ads.googleads.v11.services.GoogleAdsService
 */
export class GoogleAdsServiceClient implements IGoogleAdsServiceClient, ServiceInfo {
    typeName = GoogleAdsService.typeName;
    methods = GoogleAdsService.methods;
    options = GoogleAdsService.options;
    ...
    search(input: SearchGoogleAdsRequest, options?: RpcOptions): UnaryCall<SearchGoogleAdsRequest, SearchGoogleAdsResponse> {
        ...
        return stackIntercept<SearchGoogleAdsRequest, SearchGoogleAdsResponse>("unary", this._transport, method, opt, input);
    }
    /**
     * Returns all rows that match the search stream query.
     *
    ...
    searchStream(input: SearchGoogleAdsStreamRequest, options?: RpcOptions): ServerStreamingCall<SearchGoogleAdsStreamRequest, SearchGoogleAdsStreamResponse> {
        ...
        return stackIntercept<SearchGoogleAdsStreamRequest, SearchGoogleAdsStreamResponse>("serverStreaming", this._transport, method, opt, input);
    }
    /**
     * Creates, updates, or removes resources. This method supports atomic
     * transactions with multiple types of resources. For example, you can
    ...
    mutate(input: MutateGoogleAdsRequest, options?: RpcOptions): UnaryCall<MutateGoogleAdsRequest, MutateGoogleAdsResponse> {
        ...
        return stackIntercept<MutateGoogleAdsRequest, MutateGoogleAdsResponse>("unary", this._transport, method, opt, input);
    }
}

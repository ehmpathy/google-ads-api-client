...
class MutateAdGroupsRequest$Type extends MessageType<MutateAdGroupsRequest> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateAdGroupsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => AdGroupOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
    ...
    create(value?: PartialMessage<MutateAdGroupsRequest>): MutateAdGroupsRequest {
        ...
        if (value !== undefined)
            reflectionMergePartial<MutateAdGroupsRequest>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.AdGroupOperation operations */ 2:
                    message.operations.push(AdGroupOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: MutateAdGroupsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.operations.length; i++)
            AdGroupOperation.internalBinaryWrite(message.operations[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
 ...
 */
export const MutateAdGroupsRequest = new MutateAdGroupsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AdGroupOperation$Type extends MessageType<AdGroupOperation> {
    constructor() {
        super("google.ads.googleads.v11.services.AdGroupOperation", [
            { no: 4, name: "update_mask", kind: "message", T: () => FieldMask },
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => AdGroup },
            { no: 2, name: "update", kind: "message", oneof: "operation", T: () => AdGroup },
    ...
    create(value?: PartialMessage<AdGroupOperation>): AdGroupOperation {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<AdGroupOperation>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.AdGroup create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: AdGroup.internalBinaryRead(reader, reader.uint32(), options, (message.operation as any).create)
                    };
                    break;
                case /* google.ads.googleads.v11.resources.AdGroup update */ 2:
                    message.operation = {
                        oneofKind: "update",
                        update: AdGroup.internalBinaryRead(reader, reader.uint32(), options, (message.operation as any).update)
                    };
                    break;
    ...
    internalBinaryWrite(message: AdGroupOperation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.operation.oneofKind === "create")
            AdGroup.internalBinaryWrite(message.operation.create, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* google.ads.googleads.v11.resources.AdGroup update = 2; */
        if (message.operation.oneofKind === "update")
            AdGroup.internalBinaryWrite(message.operation.update, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* string remove = 3; */
 ...
 */
export const AdGroupOperation = new AdGroupOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateAdGroupsResponse$Type extends MessageType<MutateAdGroupsResponse> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateAdGroupsResponse", [
            { no: 3, name: "partial_failure_error", kind: "message", T: () => Status },
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MutateAdGroupResult }
        ]);
    }
    create(value?: PartialMessage<MutateAdGroupsResponse>): MutateAdGroupsResponse {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<MutateAdGroupsResponse>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateAdGroupResult results */ 2:
                    message.results.push(MutateAdGroupResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: MutateAdGroupsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.results.length; i++)
            MutateAdGroupResult.internalBinaryWrite(message.results[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const MutateAdGroupsResponse = new MutateAdGroupsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateAdGroupResult$Type extends MessageType<MutateAdGroupResult> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateAdGroupResult", [
            ...
            { no: 2, name: "ad_group", kind: "message", T: () => AdGroup }
        ]);
    }
    create(value?: PartialMessage<MutateAdGroupResult>): MutateAdGroupResult {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<MutateAdGroupResult>(this, message, value);
        return message;
    }
 ...
 */
export const MutateAdGroupResult = new MutateAdGroupResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.AdGroupService
 */
export const AdGroupService = new ServiceType("google.ads.googleads.v11.services.AdGroupService", [
    { name: "MutateAdGroups", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/adGroups:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: MutateAdGroupsRequest, O: MutateAdGroupsResponse }

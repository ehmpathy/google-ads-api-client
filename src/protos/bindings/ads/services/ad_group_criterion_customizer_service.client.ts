...
import { AdGroupCriterionCustomizerService } from "./ad_group_criterion_customizer_service";
 ...
 * @generated from protobuf service google.ads.googleads.v11.services.AdGroupCriterionCustomizerService
 */
export class AdGroupCriterionCustomizerServiceClient implements IAdGroupCriterionCustomizerServiceClient, ServiceInfo {
    typeName = AdGroupCriterionCustomizerService.typeName;
    methods = AdGroupCriterionCustomizerService.methods;
    options = AdGroupCriterionCustomizerService.options;
    ...
    mutateAdGroupCriterionCustomizers(input: MutateAdGroupCriterionCustomizersRequest, options?: RpcOptions): UnaryCall<MutateAdGroupCriterionCustomizersRequest, MutateAdGroupCriterionCustomizersResponse> {
        ...
        return stackIntercept<MutateAdGroupCriterionCustomizersRequest, MutateAdGroupCriterionCustomizersResponse>("unary", this._transport, method, opt, input);
    }
}

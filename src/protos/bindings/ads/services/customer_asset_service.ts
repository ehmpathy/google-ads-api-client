...
class MutateCustomerAssetsRequest$Type extends MessageType<MutateCustomerAssetsRequest> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomerAssetsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CustomerAssetOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
    ...
    create(value?: PartialMessage<MutateCustomerAssetsRequest>): MutateCustomerAssetsRequest {
        ...
        if (value !== undefined)
            reflectionMergePartial<MutateCustomerAssetsRequest>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.CustomerAssetOperation operations */ 2:
                    message.operations.push(CustomerAssetOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: MutateCustomerAssetsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.operations.length; i++)
            CustomerAssetOperation.internalBinaryWrite(message.operations[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
 ...
 */
export const MutateCustomerAssetsRequest = new MutateCustomerAssetsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CustomerAssetOperation$Type extends MessageType<CustomerAssetOperation> {
    constructor() {
        super("google.ads.googleads.v11.services.CustomerAssetOperation", [
            { no: 4, name: "update_mask", kind: "message", T: () => FieldMask },
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => CustomerAsset },
            { no: 3, name: "update", kind: "message", oneof: "operation", T: () => CustomerAsset },
    ...
    create(value?: PartialMessage<CustomerAssetOperation>): CustomerAssetOperation {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CustomerAssetOperation>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* google.ads.googleads.v11.resources.CustomerAsset create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: CustomerAsset.internalBinaryRead(reader, reader.uint32(), options, (message.operation as any).create)
                    };
                    break;
                case /* google.ads.googleads.v11.resources.CustomerAsset update */ 3:
                    message.operation = {
                        oneofKind: "update",
                        update: CustomerAsset.internalBinaryRead(reader, reader.uint32(), options, (message.operation as any).update)
                    };
                    break;
    ...
    internalBinaryWrite(message: CustomerAssetOperation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.operation.oneofKind === "create")
            CustomerAsset.internalBinaryWrite(message.operation.create, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* google.ads.googleads.v11.resources.CustomerAsset update = 3; */
        if (message.operation.oneofKind === "update")
            CustomerAsset.internalBinaryWrite(message.operation.update, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* string remove = 2; */
 ...
 */
export const CustomerAssetOperation = new CustomerAssetOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomerAssetsResponse$Type extends MessageType<MutateCustomerAssetsResponse> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomerAssetsResponse", [
            ...
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MutateCustomerAssetResult }
        ]);
    }
    create(value?: PartialMessage<MutateCustomerAssetsResponse>): MutateCustomerAssetsResponse {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<MutateCustomerAssetsResponse>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateCustomerAssetResult results */ 2:
                    message.results.push(MutateCustomerAssetResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: MutateCustomerAssetsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.results.length; i++)
            MutateCustomerAssetResult.internalBinaryWrite(message.results[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const MutateCustomerAssetsResponse = new MutateCustomerAssetsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomerAssetResult$Type extends MessageType<MutateCustomerAssetResult> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomerAssetResult", [
            ...
            { no: 2, name: "customer_asset", kind: "message", T: () => CustomerAsset }
        ]);
    }
    create(value?: PartialMessage<MutateCustomerAssetResult>): MutateCustomerAssetResult {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<MutateCustomerAssetResult>(this, message, value);
        return message;
    }
    ...
    internalBinaryWrite(message: MutateCustomerAssetResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.customerAsset)
            CustomerAsset.internalBinaryWrite(message.customerAsset, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const MutateCustomerAssetResult = new MutateCustomerAssetResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.CustomerAssetService
 */
export const CustomerAssetService = new ServiceType("google.ads.googleads.v11.services.CustomerAssetService", [
    { name: "MutateCustomerAssets", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/customerAssets:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: MutateCustomerAssetsRequest, O: MutateCustomerAssetsResponse }

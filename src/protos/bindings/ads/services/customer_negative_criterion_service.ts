...
class MutateCustomerNegativeCriteriaRequest$Type extends MessageType<MutateCustomerNegativeCriteriaRequest> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomerNegativeCriteriaRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => CustomerNegativeCriterionOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
    ...
    create(value?: PartialMessage<MutateCustomerNegativeCriteriaRequest>): MutateCustomerNegativeCriteriaRequest {
        ...
        if (value !== undefined)
            reflectionMergePartial<MutateCustomerNegativeCriteriaRequest>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.CustomerNegativeCriterionOperation operations */ 2:
                    message.operations.push(CustomerNegativeCriterionOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: MutateCustomerNegativeCriteriaRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.operations.length; i++)
            CustomerNegativeCriterionOperation.internalBinaryWrite(message.operations[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
 ...
 */
export const MutateCustomerNegativeCriteriaRequest = new MutateCustomerNegativeCriteriaRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CustomerNegativeCriterionOperation$Type extends MessageType<CustomerNegativeCriterionOperation> {
    constructor() {
        super("google.ads.googleads.v11.services.CustomerNegativeCriterionOperation", [
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => CustomerNegativeCriterion },
    ...
    create(value?: PartialMessage<CustomerNegativeCriterionOperation>): CustomerNegativeCriterionOperation {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CustomerNegativeCriterionOperation>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.ads.googleads.v11.resources.CustomerNegativeCriterion create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: CustomerNegativeCriterion.internalBinaryRead(reader, reader.uint32(), options, (message.operation as any).create)
                    };
                    break;
    ...
    internalBinaryWrite(message: CustomerNegativeCriterionOperation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.operation.oneofKind === "create")
            CustomerNegativeCriterion.internalBinaryWrite(message.operation.create, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* string remove = 2; */
 ...
 */
export const CustomerNegativeCriterionOperation = new CustomerNegativeCriterionOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomerNegativeCriteriaResponse$Type extends MessageType<MutateCustomerNegativeCriteriaResponse> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomerNegativeCriteriaResponse", [
            ...
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MutateCustomerNegativeCriteriaResult }
        ]);
    }
    create(value?: PartialMessage<MutateCustomerNegativeCriteriaResponse>): MutateCustomerNegativeCriteriaResponse {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<MutateCustomerNegativeCriteriaResponse>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateCustomerNegativeCriteriaResult results */ 2:
                    message.results.push(MutateCustomerNegativeCriteriaResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: MutateCustomerNegativeCriteriaResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.results.length; i++)
            MutateCustomerNegativeCriteriaResult.internalBinaryWrite(message.results[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const MutateCustomerNegativeCriteriaResponse = new MutateCustomerNegativeCriteriaResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateCustomerNegativeCriteriaResult$Type extends MessageType<MutateCustomerNegativeCriteriaResult> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateCustomerNegativeCriteriaResult", [
            ...
            { no: 2, name: "customer_negative_criterion", kind: "message", T: () => CustomerNegativeCriterion }
        ]);
    }
    create(value?: PartialMessage<MutateCustomerNegativeCriteriaResult>): MutateCustomerNegativeCriteriaResult {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<MutateCustomerNegativeCriteriaResult>(this, message, value);
        return message;
    }
    ...
    internalBinaryWrite(message: MutateCustomerNegativeCriteriaResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.customerNegativeCriterion)
            CustomerNegativeCriterion.internalBinaryWrite(message.customerNegativeCriterion, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const MutateCustomerNegativeCriteriaResult = new MutateCustomerNegativeCriteriaResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.CustomerNegativeCriterionService
 */
export const CustomerNegativeCriterionService = new ServiceType("google.ads.googleads.v11.services.CustomerNegativeCriterionService", [
    { name: "MutateCustomerNegativeCriteria", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/customerNegativeCriteria:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: MutateCustomerNegativeCriteriaRequest, O: MutateCustomerNegativeCriteriaResponse }

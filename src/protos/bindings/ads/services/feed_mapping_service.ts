...
class MutateFeedMappingsRequest$Type extends MessageType<MutateFeedMappingsRequest> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateFeedMappingsRequest", [
            ...
            { no: 2, name: "operations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => FeedMappingOperation, options: { "google.api.field_behavior": ["REQUIRED"] } },
    ...
    create(value?: PartialMessage<MutateFeedMappingsRequest>): MutateFeedMappingsRequest {
        ...
        if (value !== undefined)
            reflectionMergePartial<MutateFeedMappingsRequest>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.FeedMappingOperation operations */ 2:
                    message.operations.push(FeedMappingOperation.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: MutateFeedMappingsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.operations.length; i++)
            FeedMappingOperation.internalBinaryWrite(message.operations[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
 ...
 */
export const MutateFeedMappingsRequest = new MutateFeedMappingsRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class FeedMappingOperation$Type extends MessageType<FeedMappingOperation> {
    constructor() {
        super("google.ads.googleads.v11.services.FeedMappingOperation", [
            { no: 1, name: "create", kind: "message", oneof: "operation", T: () => FeedMapping },
    ...
    create(value?: PartialMessage<FeedMappingOperation>): FeedMappingOperation {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<FeedMappingOperation>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* google.ads.googleads.v11.resources.FeedMapping create */ 1:
                    message.operation = {
                        oneofKind: "create",
                        create: FeedMapping.internalBinaryRead(reader, reader.uint32(), options, (message.operation as any).create)
                    };
                    break;
    ...
    internalBinaryWrite(message: FeedMappingOperation, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.operation.oneofKind === "create")
            FeedMapping.internalBinaryWrite(message.operation.create, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* string remove = 3; */
 ...
 */
export const FeedMappingOperation = new FeedMappingOperation$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateFeedMappingsResponse$Type extends MessageType<MutateFeedMappingsResponse> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateFeedMappingsResponse", [
            { no: 3, name: "partial_failure_error", kind: "message", T: () => Status },
            { no: 2, name: "results", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => MutateFeedMappingResult }
        ]);
    }
    create(value?: PartialMessage<MutateFeedMappingsResponse>): MutateFeedMappingsResponse {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<MutateFeedMappingsResponse>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated google.ads.googleads.v11.services.MutateFeedMappingResult results */ 2:
                    message.results.push(MutateFeedMappingResult.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: MutateFeedMappingsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        for (let i = 0; i < message.results.length; i++)
            MutateFeedMappingResult.internalBinaryWrite(message.results[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const MutateFeedMappingsResponse = new MutateFeedMappingsResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MutateFeedMappingResult$Type extends MessageType<MutateFeedMappingResult> {
    constructor() {
        super("google.ads.googleads.v11.services.MutateFeedMappingResult", [
            ...
            { no: 2, name: "feed_mapping", kind: "message", T: () => FeedMapping }
        ]);
    }
    create(value?: PartialMessage<MutateFeedMappingResult>): MutateFeedMappingResult {
        ...
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<MutateFeedMappingResult>(this, message, value);
        return message;
    }
    ...
    internalBinaryWrite(message: MutateFeedMappingResult, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.feedMapping)
            FeedMapping.internalBinaryWrite(message.feedMapping, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
export const MutateFeedMappingResult = new MutateFeedMappingResult$Type();
/**
 * @generated ServiceType for protobuf service google.ads.googleads.v11.services.FeedMappingService
 */
export const FeedMappingService = new ServiceType("google.ads.googleads.v11.services.FeedMappingService", [
    { name: "MutateFeedMappings", options: { "google.api.http": { post: "/v11/customers/{customer_id=*}/feedMappings:mutate", body: "*" }, "google.api.method_signature": ["customer_id,operations"] }, I: MutateFeedMappingsRequest, O: MutateFeedMappingsResponse }

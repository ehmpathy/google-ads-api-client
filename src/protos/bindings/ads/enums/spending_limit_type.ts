...
// @generated from protobuf file "ads/enums/spending_limit_type.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class SpendingLimitTypeEnum$Type extends MessageType<SpendingLimitTypeEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.SpendingLimitTypeEnum", []);
    }
    create(value?: PartialMessage<SpendingLimitTypeEnum>): SpendingLimitTypeEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<SpendingLimitTypeEnum>(this, message, value);
        return message;
    }
 ...
 */
export const SpendingLimitTypeEnum = new SpendingLimitTypeEnum$Type();

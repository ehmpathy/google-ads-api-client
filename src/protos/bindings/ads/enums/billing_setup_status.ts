...
// @generated from protobuf file "ads/enums/billing_setup_status.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class BillingSetupStatusEnum$Type extends MessageType<BillingSetupStatusEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.BillingSetupStatusEnum", []);
    }
    create(value?: PartialMessage<BillingSetupStatusEnum>): BillingSetupStatusEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<BillingSetupStatusEnum>(this, message, value);
        return message;
    }
 ...
 */
export const BillingSetupStatusEnum = new BillingSetupStatusEnum$Type();

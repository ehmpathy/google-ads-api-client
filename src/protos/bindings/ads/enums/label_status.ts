...
// @generated from protobuf file "ads/enums/label_status.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class LabelStatusEnum$Type extends MessageType<LabelStatusEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.LabelStatusEnum", []);
    }
    create(value?: PartialMessage<LabelStatusEnum>): LabelStatusEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<LabelStatusEnum>(this, message, value);
        return message;
    }
 ...
 */
export const LabelStatusEnum = new LabelStatusEnum$Type();

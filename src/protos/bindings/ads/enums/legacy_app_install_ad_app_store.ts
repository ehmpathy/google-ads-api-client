...
// @generated from protobuf file "ads/enums/legacy_app_install_ad_app_store.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class LegacyAppInstallAdAppStoreEnum$Type extends MessageType<LegacyAppInstallAdAppStoreEnum> {
    constructor() {
    ...
    create(value?: PartialMessage<LegacyAppInstallAdAppStoreEnum>): LegacyAppInstallAdAppStoreEnum {
        ...
        if (value !== undefined)
            reflectionMergePartial<LegacyAppInstallAdAppStoreEnum>(this, message, value);
        return message;
    }
 ...
 */
export const LegacyAppInstallAdAppStoreEnum = new LegacyAppInstallAdAppStoreEnum$Type();

...
// @generated from protobuf file "ads/enums/ad_group_status.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class AdGroupStatusEnum$Type extends MessageType<AdGroupStatusEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.AdGroupStatusEnum", []);
    }
    create(value?: PartialMessage<AdGroupStatusEnum>): AdGroupStatusEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<AdGroupStatusEnum>(this, message, value);
        return message;
    }
 ...
 */
export const AdGroupStatusEnum = new AdGroupStatusEnum$Type();

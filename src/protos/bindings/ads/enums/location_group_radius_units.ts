...
// @generated from protobuf file "ads/enums/location_group_radius_units.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class LocationGroupRadiusUnitsEnum$Type extends MessageType<LocationGroupRadiusUnitsEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.LocationGroupRadiusUnitsEnum", []);
    }
    create(value?: PartialMessage<LocationGroupRadiusUnitsEnum>): LocationGroupRadiusUnitsEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<LocationGroupRadiusUnitsEnum>(this, message, value);
        return message;
    }
 ...
 */
export const LocationGroupRadiusUnitsEnum = new LocationGroupRadiusUnitsEnum$Type();

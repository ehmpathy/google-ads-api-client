...
// @generated from protobuf file "ads/enums/app_campaign_app_store.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class AppCampaignAppStoreEnum$Type extends MessageType<AppCampaignAppStoreEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.AppCampaignAppStoreEnum", []);
    }
    create(value?: PartialMessage<AppCampaignAppStoreEnum>): AppCampaignAppStoreEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<AppCampaignAppStoreEnum>(this, message, value);
        return message;
    }
 ...
 */
export const AppCampaignAppStoreEnum = new AppCampaignAppStoreEnum$Type();

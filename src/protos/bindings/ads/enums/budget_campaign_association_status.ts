...
// @generated from protobuf file "ads/enums/budget_campaign_association_status.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class BudgetCampaignAssociationStatusEnum$Type extends MessageType<BudgetCampaignAssociationStatusEnum> {
    constructor() {
    ...
    create(value?: PartialMessage<BudgetCampaignAssociationStatusEnum>): BudgetCampaignAssociationStatusEnum {
        ...
        if (value !== undefined)
            reflectionMergePartial<BudgetCampaignAssociationStatusEnum>(this, message, value);
        return message;
    }
 ...
 */
export const BudgetCampaignAssociationStatusEnum = new BudgetCampaignAssociationStatusEnum$Type();

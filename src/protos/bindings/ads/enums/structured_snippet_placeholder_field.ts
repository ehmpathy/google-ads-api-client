...
// @generated from protobuf file "ads/enums/structured_snippet_placeholder_field.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class StructuredSnippetPlaceholderFieldEnum$Type extends MessageType<StructuredSnippetPlaceholderFieldEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.StructuredSnippetPlaceholderFieldEnum", []);
    }
    create(value?: PartialMessage<StructuredSnippetPlaceholderFieldEnum>): StructuredSnippetPlaceholderFieldEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<StructuredSnippetPlaceholderFieldEnum>(this, message, value);
        return message;
    }
 ...
 */
export const StructuredSnippetPlaceholderFieldEnum = new StructuredSnippetPlaceholderFieldEnum$Type();

...
// @generated from protobuf file "ads/enums/asset_link_status.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class AssetLinkStatusEnum$Type extends MessageType<AssetLinkStatusEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.AssetLinkStatusEnum", []);
    }
    create(value?: PartialMessage<AssetLinkStatusEnum>): AssetLinkStatusEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<AssetLinkStatusEnum>(this, message, value);
        return message;
    }
 ...
 */
export const AssetLinkStatusEnum = new AssetLinkStatusEnum$Type();

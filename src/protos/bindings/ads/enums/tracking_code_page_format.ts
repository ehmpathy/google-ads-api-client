...
// @generated from protobuf file "ads/enums/tracking_code_page_format.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class TrackingCodePageFormatEnum$Type extends MessageType<TrackingCodePageFormatEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.TrackingCodePageFormatEnum", []);
    }
    create(value?: PartialMessage<TrackingCodePageFormatEnum>): TrackingCodePageFormatEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<TrackingCodePageFormatEnum>(this, message, value);
        return message;
    }
 ...
 */
export const TrackingCodePageFormatEnum = new TrackingCodePageFormatEnum$Type();

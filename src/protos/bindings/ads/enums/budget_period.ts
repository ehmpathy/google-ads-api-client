...
// @generated from protobuf file "ads/enums/budget_period.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class BudgetPeriodEnum$Type extends MessageType<BudgetPeriodEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.BudgetPeriodEnum", []);
    }
    create(value?: PartialMessage<BudgetPeriodEnum>): BudgetPeriodEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<BudgetPeriodEnum>(this, message, value);
        return message;
    }
 ...
 */
export const BudgetPeriodEnum = new BudgetPeriodEnum$Type();

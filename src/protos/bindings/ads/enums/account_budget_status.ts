...
// @generated from protobuf file "ads/enums/account_budget_status.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class AccountBudgetStatusEnum$Type extends MessageType<AccountBudgetStatusEnum> {
    constructor() {
    ...
    create(value?: PartialMessage<AccountBudgetStatusEnum>): AccountBudgetStatusEnum {
        ...
        if (value !== undefined)
            reflectionMergePartial<AccountBudgetStatusEnum>(this, message, value);
        return message;
    }
 ...
 */
export const AccountBudgetStatusEnum = new AccountBudgetStatusEnum$Type();

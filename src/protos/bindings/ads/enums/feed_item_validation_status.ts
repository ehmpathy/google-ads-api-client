...
// @generated from protobuf file "ads/enums/feed_item_validation_status.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class FeedItemValidationStatusEnum$Type extends MessageType<FeedItemValidationStatusEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.FeedItemValidationStatusEnum", []);
    }
    create(value?: PartialMessage<FeedItemValidationStatusEnum>): FeedItemValidationStatusEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<FeedItemValidationStatusEnum>(this, message, value);
        return message;
    }
 ...
 */
export const FeedItemValidationStatusEnum = new FeedItemValidationStatusEnum$Type();

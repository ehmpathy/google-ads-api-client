...
// @generated from protobuf file "ads/enums/shared_set_type.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class SharedSetTypeEnum$Type extends MessageType<SharedSetTypeEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.SharedSetTypeEnum", []);
    }
    create(value?: PartialMessage<SharedSetTypeEnum>): SharedSetTypeEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<SharedSetTypeEnum>(this, message, value);
        return message;
    }
 ...
 */
export const SharedSetTypeEnum = new SharedSetTypeEnum$Type();

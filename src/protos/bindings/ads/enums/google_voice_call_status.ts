...
// @generated from protobuf file "ads/enums/google_voice_call_status.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class GoogleVoiceCallStatusEnum$Type extends MessageType<GoogleVoiceCallStatusEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.GoogleVoiceCallStatusEnum", []);
    }
    create(value?: PartialMessage<GoogleVoiceCallStatusEnum>): GoogleVoiceCallStatusEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<GoogleVoiceCallStatusEnum>(this, message, value);
        return message;
    }
 ...
 */
export const GoogleVoiceCallStatusEnum = new GoogleVoiceCallStatusEnum$Type();

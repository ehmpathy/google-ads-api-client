...
// @generated from protobuf file "ads/enums/customizer_attribute_status.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class CustomizerAttributeStatusEnum$Type extends MessageType<CustomizerAttributeStatusEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.CustomizerAttributeStatusEnum", []);
    }
    create(value?: PartialMessage<CustomizerAttributeStatusEnum>): CustomizerAttributeStatusEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<CustomizerAttributeStatusEnum>(this, message, value);
        return message;
    }
 ...
 */
export const CustomizerAttributeStatusEnum = new CustomizerAttributeStatusEnum$Type();

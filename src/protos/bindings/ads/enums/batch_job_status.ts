...
// @generated from protobuf file "ads/enums/batch_job_status.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class BatchJobStatusEnum$Type extends MessageType<BatchJobStatusEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.BatchJobStatusEnum", []);
    }
    create(value?: PartialMessage<BatchJobStatusEnum>): BatchJobStatusEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<BatchJobStatusEnum>(this, message, value);
        return message;
    }
 ...
 */
export const BatchJobStatusEnum = new BatchJobStatusEnum$Type();

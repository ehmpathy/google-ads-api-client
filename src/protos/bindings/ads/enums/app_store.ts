...
// @generated from protobuf file "ads/enums/app_store.proto" (package "google.ads.googleads.v11.enums", syntax proto3)
// tslint:disable
//
...
class AppStoreEnum$Type extends MessageType<AppStoreEnum> {
    constructor() {
        super("google.ads.googleads.v11.enums.AppStoreEnum", []);
    }
    create(value?: PartialMessage<AppStoreEnum>): AppStoreEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<AppStoreEnum>(this, message, value);
        return message;
    }
 ...
 */
export const AppStoreEnum = new AppStoreEnum$Type();

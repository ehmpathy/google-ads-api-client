...
// @generated from protobuf file "ads/resources/ad_group_asset.proto" (package "google.ads.googleads.v11.resources", syntax proto3)
// tslint:disable
//
...
class AdGroupAsset$Type extends MessageType<AdGroupAsset> {
    constructor() {
        super("google.ads.googleads.v11.resources.AdGroupAsset", [
            ...
            { no: 4, name: "field_type", kind: "enum", T: () => ["google.ads.googleads.v11.enums.AssetFieldTypeEnum.AssetFieldType", AssetFieldTypeEnum_AssetFieldType], options: { "google.api.field_behavior": ["REQUIRED", "IMMUTABLE"] } },
            { no: 6, name: "source", kind: "enum", T: () => ["google.ads.googleads.v11.enums.AssetSourceEnum.AssetSource", AssetSourceEnum_AssetSource], options: { "google.api.field_behavior": ["OUTPUT_ONLY"] } },
    ...
    create(value?: PartialMessage<AdGroupAsset>): AdGroupAsset {
        ...
        if (value !== undefined)
            reflectionMergePartial<AdGroupAsset>(this, message, value);
        return message;
    }
 ...
 */
export const AdGroupAsset = new AdGroupAsset$Type();

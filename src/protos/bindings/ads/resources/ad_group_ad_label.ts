...
// @generated from protobuf file "ads/resources/ad_group_ad_label.proto" (package "google.ads.googleads.v11.resources", syntax proto3)
// tslint:disable
//
...
class AdGroupAdLabel$Type extends MessageType<AdGroupAdLabel> {
    constructor() {
        super("google.ads.googleads.v11.resources.AdGroupAdLabel", [
            { no: 1, name: "resource_name", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "google.api.field_behavior": ["IMMUTABLE"], "google.api.resource_reference": { type: "googleads.googleapis.com/AdGroupAdLabel" } } },
            { no: 4, name: "ad_group_ad", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/, options: { "google.api.field_behavior": ["IMMUTABLE"], "google.api.resource_reference": { type: "googleads.googleapis.com/AdGroupAd" } } },
        ...
        ], { "google.api.resource": { type: "googleads.googleapis.com/AdGroupAdLabel", pattern: ["customers/{customer_id}/adGroupAdLabels/{ad_group_id}~{ad_id}~{label_id}"] } });
    }
    create(value?: PartialMessage<AdGroupAdLabel>): AdGroupAdLabel {
        const message = { resourceName: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<AdGroupAdLabel>(this, message, value);
        return message;
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string resource_name */ 1:
                    ...
                    break;
                case /* optional string ad_group_ad */ 4:
    ...
    internalBinaryWrite(message: AdGroupAdLabel, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.adGroupAd !== undefined)
            writer.tag(4, WireType.LengthDelimited).string(message.adGroupAd);
 ...
 */
export const AdGroupAdLabel = new AdGroupAdLabel$Type();

...
// @generated from protobuf file "ads/resources/life_event.proto" (package "google.ads.googleads.v11.resources", syntax proto3)
// tslint:disable
//
...
class LifeEvent$Type extends MessageType<LifeEvent> {
    constructor() {
    ...
    create(value?: PartialMessage<LifeEvent>): LifeEvent {
        ...
        if (value !== undefined)
            reflectionMergePartial<LifeEvent>(this, message, value);
        return message;
    }
 ...
 */
export const LifeEvent = new LifeEvent$Type();

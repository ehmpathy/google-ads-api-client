...
// @generated from protobuf file "ads/resources/ad_group_criterion_customizer.proto" (package "google.ads.googleads.v11.resources", syntax proto3)
// tslint:disable
//
 ...
 *
 * @generated from protobuf message google.ads.googleads.v11.resources.AdGroupCriterionCustomizer
 */
export interface AdGroupCriterionCustomizer {
     ...
     *
     * @generated from protobuf field: optional string ad_group_criterion = 2;
     */
...
class AdGroupCriterionCustomizer$Type extends MessageType<AdGroupCriterionCustomizer> {
    constructor() {
    ...
    create(value?: PartialMessage<AdGroupCriterionCustomizer>): AdGroupCriterionCustomizer {
        const message = { resourceName: "", customizerAttribute: "", status: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<AdGroupCriterionCustomizer>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AdGroupCriterionCustomizer): AdGroupCriterionCustomizer {
    ...
    internalBinaryWrite(message: AdGroupCriterionCustomizer, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string resource_name = 1; */
        if (message.resourceName !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.resourceName);
        /* optional string ad_group_criterion = 2; */
        if (message.adGroupCriterion !== undefined)
            writer.tag(2, WireType.LengthDelimited).string(message.adGroupCriterion);
 ...
 */
export const AdGroupCriterionCustomizer = new AdGroupCriterionCustomizer$Type();

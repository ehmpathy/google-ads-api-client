...
// @generated from protobuf file "ads/resources/hotel_performance_view.proto" (package "google.ads.googleads.v11.resources", syntax proto3)
// tslint:disable
//
...
class HotelPerformanceView$Type extends MessageType<HotelPerformanceView> {
    constructor() {
    ...
    create(value?: PartialMessage<HotelPerformanceView>): HotelPerformanceView {
        ...
        if (value !== undefined)
            reflectionMergePartial<HotelPerformanceView>(this, message, value);
        return message;
    }
 ...
 */
export const HotelPerformanceView = new HotelPerformanceView$Type();

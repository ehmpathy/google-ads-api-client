...
// @generated from protobuf file "ads/resources/hotel_group_view.proto" (package "google.ads.googleads.v11.resources", syntax proto3)
// tslint:disable
//
...
class HotelGroupView$Type extends MessageType<HotelGroupView> {
    constructor() {
    ...
    create(value?: PartialMessage<HotelGroupView>): HotelGroupView {
        ...
        if (value !== undefined)
            reflectionMergePartial<HotelGroupView>(this, message, value);
        return message;
    }
 ...
 */
export const HotelGroupView = new HotelGroupView$Type();

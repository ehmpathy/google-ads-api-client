...
// @generated from protobuf file "ads/resources/webpage_view.proto" (package "google.ads.googleads.v11.resources", syntax proto3)
// tslint:disable
//
...
class WebpageView$Type extends MessageType<WebpageView> {
    constructor() {
    ...
    create(value?: PartialMessage<WebpageView>): WebpageView {
        ...
        if (value !== undefined)
            reflectionMergePartial<WebpageView>(this, message, value);
        return message;
    }
 ...
 */
export const WebpageView = new WebpageView$Type();

...
// @generated from protobuf file "ads/resources/campaign_audience_view.proto" (package "google.ads.googleads.v11.resources", syntax proto3)
// tslint:disable
//
...
class CampaignAudienceView$Type extends MessageType<CampaignAudienceView> {
    constructor() {
    ...
    create(value?: PartialMessage<CampaignAudienceView>): CampaignAudienceView {
        ...
        if (value !== undefined)
            reflectionMergePartial<CampaignAudienceView>(this, message, value);
        return message;
    }
 ...
 */
export const CampaignAudienceView = new CampaignAudienceView$Type();

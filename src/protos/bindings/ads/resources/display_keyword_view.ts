...
// @generated from protobuf file "ads/resources/display_keyword_view.proto" (package "google.ads.googleads.v11.resources", syntax proto3)
// tslint:disable
//
...
class DisplayKeywordView$Type extends MessageType<DisplayKeywordView> {
    constructor() {
    ...
    create(value?: PartialMessage<DisplayKeywordView>): DisplayKeywordView {
        ...
        if (value !== undefined)
            reflectionMergePartial<DisplayKeywordView>(this, message, value);
        return message;
    }
 ...
 */
export const DisplayKeywordView = new DisplayKeywordView$Type();

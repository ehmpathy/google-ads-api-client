...
// @generated from protobuf file "ads/common/explorer_auto_optimizer_setting.proto" (package "google.ads.googleads.v11.common", syntax proto3)
// tslint:disable
//
...
class ExplorerAutoOptimizerSetting$Type extends MessageType<ExplorerAutoOptimizerSetting> {
    constructor() {
    ...
    create(value?: PartialMessage<ExplorerAutoOptimizerSetting>): ExplorerAutoOptimizerSetting {
        ...
        if (value !== undefined)
            reflectionMergePartial<ExplorerAutoOptimizerSetting>(this, message, value);
        return message;
    }
 ...
 */
export const ExplorerAutoOptimizerSetting = new ExplorerAutoOptimizerSetting$Type();

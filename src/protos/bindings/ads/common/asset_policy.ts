...
// @generated from protobuf file "ads/common/asset_policy.proto" (package "google.ads.googleads.v11.common", syntax proto3)
// tslint:disable
//
 ...
 *
 * @generated from protobuf message google.ads.googleads.v11.common.AdAssetPolicySummary
 */
...
class AdAssetPolicySummary$Type extends MessageType<AdAssetPolicySummary> {
    constructor() {
    ...
    create(value?: PartialMessage<AdAssetPolicySummary>): AdAssetPolicySummary {
        const message = { policyTopicEntries: [], reviewStatus: 0, approvalStatus: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<AdAssetPolicySummary>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AdAssetPolicySummary): AdAssetPolicySummary {
    ...
    internalBinaryWrite(message: AdAssetPolicySummary, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
 ...
 */
export const AdAssetPolicySummary = new AdAssetPolicySummary$Type();

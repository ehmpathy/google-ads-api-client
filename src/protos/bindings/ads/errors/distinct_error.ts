...
// @generated from protobuf file "ads/errors/distinct_error.proto" (package "google.ads.googleads.v11.errors", syntax proto3)
// tslint:disable
//
...
class DistinctErrorEnum$Type extends MessageType<DistinctErrorEnum> {
    constructor() {
    ...
    create(value?: PartialMessage<DistinctErrorEnum>): DistinctErrorEnum {
        ...
        if (value !== undefined)
            reflectionMergePartial<DistinctErrorEnum>(this, message, value);
        return message;
    }
 ...
 */
export const DistinctErrorEnum = new DistinctErrorEnum$Type();

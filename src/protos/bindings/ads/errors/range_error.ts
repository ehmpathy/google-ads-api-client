...
// @generated from protobuf file "ads/errors/range_error.proto" (package "google.ads.googleads.v11.errors", syntax proto3)
// tslint:disable
//
...
class RangeErrorEnum$Type extends MessageType<RangeErrorEnum> {
    constructor() {
        super("google.ads.googleads.v11.errors.RangeErrorEnum", []);
    }
    create(value?: PartialMessage<RangeErrorEnum>): RangeErrorEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<RangeErrorEnum>(this, message, value);
        return message;
    }
 ...
 */
export const RangeErrorEnum = new RangeErrorEnum$Type();

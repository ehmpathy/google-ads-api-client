...
// @generated from protobuf file "ads/errors/policy_validation_parameter_error.proto" (package "google.ads.googleads.v11.errors", syntax proto3)
// tslint:disable
//
...
class PolicyValidationParameterErrorEnum$Type extends MessageType<PolicyValidationParameterErrorEnum> {
    constructor() {
        super("google.ads.googleads.v11.errors.PolicyValidationParameterErrorEnum", []);
    }
    create(value?: PartialMessage<PolicyValidationParameterErrorEnum>): PolicyValidationParameterErrorEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<PolicyValidationParameterErrorEnum>(this, message, value);
        return message;
    }
 ...
 */
export const PolicyValidationParameterErrorEnum = new PolicyValidationParameterErrorEnum$Type();

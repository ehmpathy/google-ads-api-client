...
// @generated from protobuf file "ads/errors/language_code_error.proto" (package "google.ads.googleads.v11.errors", syntax proto3)
// tslint:disable
//
...
class LanguageCodeErrorEnum$Type extends MessageType<LanguageCodeErrorEnum> {
    constructor() {
        super("google.ads.googleads.v11.errors.LanguageCodeErrorEnum", []);
    }
    create(value?: PartialMessage<LanguageCodeErrorEnum>): LanguageCodeErrorEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<LanguageCodeErrorEnum>(this, message, value);
        return message;
    }
 ...
 */
export const LanguageCodeErrorEnum = new LanguageCodeErrorEnum$Type();

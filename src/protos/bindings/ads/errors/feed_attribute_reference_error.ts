...
// @generated from protobuf file "ads/errors/feed_attribute_reference_error.proto" (package "google.ads.googleads.v11.errors", syntax proto3)
// tslint:disable
//
...
class FeedAttributeReferenceErrorEnum$Type extends MessageType<FeedAttributeReferenceErrorEnum> {
    constructor() {
        super("google.ads.googleads.v11.errors.FeedAttributeReferenceErrorEnum", []);
    }
    create(value?: PartialMessage<FeedAttributeReferenceErrorEnum>): FeedAttributeReferenceErrorEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<FeedAttributeReferenceErrorEnum>(this, message, value);
        return message;
    }
 ...
 */
export const FeedAttributeReferenceErrorEnum = new FeedAttributeReferenceErrorEnum$Type();

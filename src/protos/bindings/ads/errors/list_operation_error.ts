...
// @generated from protobuf file "ads/errors/list_operation_error.proto" (package "google.ads.googleads.v11.errors", syntax proto3)
// tslint:disable
//
...
class ListOperationErrorEnum$Type extends MessageType<ListOperationErrorEnum> {
    constructor() {
        super("google.ads.googleads.v11.errors.ListOperationErrorEnum", []);
    }
    create(value?: PartialMessage<ListOperationErrorEnum>): ListOperationErrorEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<ListOperationErrorEnum>(this, message, value);
        return message;
    }
 ...
 */
export const ListOperationErrorEnum = new ListOperationErrorEnum$Type();

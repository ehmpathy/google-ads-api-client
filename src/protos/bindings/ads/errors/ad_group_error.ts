...
// @generated from protobuf file "ads/errors/ad_group_error.proto" (package "google.ads.googleads.v11.errors", syntax proto3)
// tslint:disable
//
 ...
 *
 * @generated from protobuf message google.ads.googleads.v11.errors.AdGroupErrorEnum
 */
...
class AdGroupErrorEnum$Type extends MessageType<AdGroupErrorEnum> {
    constructor() {
        super("google.ads.googleads.v11.errors.AdGroupErrorEnum", []);
    }
    create(value?: PartialMessage<AdGroupErrorEnum>): AdGroupErrorEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<AdGroupErrorEnum>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: AdGroupErrorEnum): AdGroupErrorEnum {
        return target ?? this.create();
    }
    internalBinaryWrite(message: AdGroupErrorEnum, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
 ...
 */
export const AdGroupErrorEnum = new AdGroupErrorEnum$Type();

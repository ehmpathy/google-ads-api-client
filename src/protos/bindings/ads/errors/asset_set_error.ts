...
// @generated from protobuf file "ads/errors/asset_set_error.proto" (package "google.ads.googleads.v11.errors", syntax proto3)
// tslint:disable
//
...
class AssetSetErrorEnum$Type extends MessageType<AssetSetErrorEnum> {
    constructor() {
        super("google.ads.googleads.v11.errors.AssetSetErrorEnum", []);
    }
    create(value?: PartialMessage<AssetSetErrorEnum>): AssetSetErrorEnum {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<AssetSetErrorEnum>(this, message, value);
        return message;
    }
 ...
 */
export const AssetSetErrorEnum = new AssetSetErrorEnum$Type();
